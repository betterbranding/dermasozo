/* DermaSoZo GHL page loader v4 (instant swap) — Products */
(function () {
  ...
  var page = fetch(GH + '/pages/products.html?v=5').then(function (r) { return r.text(); });
  ...
  var head = '<style id="dszSplash">html{background:#13224E!important}body{display:none!important}' +
    ...
    '<link rel="preload" as="image" href="' + GH + '/images/rm-solo.jpg">';
  document.write(head);
